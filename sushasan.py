...
USER_AGENT_STRING = 'Mozilla/5.0 ({} {}-bit) sushasan/{}'.format(sys.platform, sys.maxsize.bit_length() + 1, __version__)
...
def run(**kwargs):
	...
	parser.add_argument('--version', action='version', version='sushasan {}'.format(__version__), help=argparse.SUPPRESS)
